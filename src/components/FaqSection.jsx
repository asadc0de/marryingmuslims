...
const faqData = [
  ...
  },
  {
   ...
   {
    id: 11,
    question: "Can I share my social media?",
    answer: "We do not allow the promotion of personal links, such as social media or any external sites, for security reasons and to remain within our platform's guidelines. Additionally, do not include any contact details in the sign-up fields that do not explicitly ask for them, as this is not allowed. Any user found violating these terms may be banned."
  },
