...
const TermsConditions = () => {
  ...
  <div className="min-h-screen bg-pink-50 py-8 px-4 relative">
    {/* Anchor sections for Quick Links smooth scroll */}
    <div id="howitworks" style={{ position: 'absolute', top: 0, height: 1, width: 1 }} tabIndex={-1} aria-hidden="true"></div>
    <div id="ourvision" style={{ position: 'absolute', top: 0, height: 1, width: 1 }} tabIndex={-1} aria-hidden="true"></div>
    <div id="faq" style={{ position: 'absolute', top: 0, height: 1, width: 1 }} tabIndex={-1} aria-hidden="true"></div>
